...
import cn.szse.users.service.impl.NormalUserService;

@WebServlet("/normalSearch")
public class NormalUserSearchServlet extends BaseServlet {

	private static final long serialVersionUID = -6527532291672549929L;
	
	private IUserService userService = new NormalUserService();
